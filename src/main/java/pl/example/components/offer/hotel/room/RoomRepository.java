...
public interface RoomRepository extends JpaRepository<Room, Long> {
	...
	List<Room> findAllByHotelIdAndRoomCategoryOrderByHotelId(long hotelId, RoomCategory roomCategory);
	...
	@Query(value = "SELECT * FROM rooms r											\r\n" + 
			...
			"AND (r.number_of_double_beds*2) + r.number_of_single_beds >= :persons	\r\n" + 
	...
	@Query(value = "SELECT * FROM rooms r											\r\n" + 
			...
			"ORDER BY r.room_price;", nativeQuery = true)
	List<Room> findAvailableRoomsByCategory(Long hotelId, LocalDate departure, LocalDate returnDate, Integer persons, Long roomCategoryId);
}
